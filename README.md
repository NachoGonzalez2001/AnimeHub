...
│   ├── opyend/                   # Openings y Endings sobre anime buscado
|   ├── top-anime/ 
...
### HU-007: Escuchar Openings y Endings
**Como** fan de anime  
**Quiero** ver que openings y endings tienen ciertos animes
**Para** ver el video y/o escuchar la cancion 

**Criterios de Aceptación:**
- ✅ Puedo ver openings y endings de cualquier anime ingresado
- ✅ Veo el titulo del opening/ending
- ✅ Veo el autor del opening/ending
- ✅ Veo que episodios abarca ese opening/ending
- ✅ Boton de escuchar que redirige a Youtube
...
```
        ...
        │                  │                 │                   |                        |
   ┌────▼────┐       ┌─────▼─────┐      ┌────▼────┐         ┌────▼─────┐        ┌─────────▼────────┐
   │  Anime  │       │   Manga   │      │Rankings │         │Personajes│        │Openings y Endings│
   │ Search  │       │  Search   │      │         │         │          │        │                  │
   └────┬────┘       └─────┬─────┘      └────┬────┘         └────┬─────┘        └─────────┬────────┘
        │                  │                 │                   |                        |
   ┌────▼────┐       ┌─────▼─────┐      ┌────▼────┐         ┌────▼────┐              ┌────▼────┐
   │ Anime   │       │   Manga   │      │Top Anime│         │Personaje│              │Opening  │
   │Details  │       │ Details   │      │Top Manga│         │Details  │              │Ending   │
   │+ Chars  │       │+ Chars    │      └─────────┘         │Seiyu    │              └─────────┘
   └─────────┘       └───────────┘                          └─────────┘
                           │           
                     ┌─────▼─────┐    
